...
all_sites = set(spacex_df['Launch Site'])
choices = [{'label': 'All Sites', 'value': 'ALL'}]
for site in all_sites:
    choices.append({'label': site, 'value': site})
...
def get_pie_chart(entered_site):
    filtered_df = spacex_df[['Launch Site','class']].groupby(['Launch Site','class']).size().reset_index(name='Count')
